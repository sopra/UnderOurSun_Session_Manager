...
- カードタイプの選択機能
- ユーザー認証・マルチユーザー対応
- シナリオの共有機能（エクスポート/インポート）
- 画像・アイコンのアップロード
- プレイ履歴・統計機能
- ダークモード対応
- データベース統合（Supabase/Firebase/PostgreSQL）
...
### 完了済み
1. **Phase 1**: プロジェクトセットアップ、基本構造構築 ✅
2. **Phase 2**: セッション一覧・カード表示機能（ローカルストレージ） ✅
3. **Phase 3**: セッション・カード編集機能 ✅

### 今後の予定
4. **Phase 4**: データベース統合・認証機能
5. **Phase 5**: 共有・エクスポート機能
6. **Phase 6**: 統計・履歴機能
